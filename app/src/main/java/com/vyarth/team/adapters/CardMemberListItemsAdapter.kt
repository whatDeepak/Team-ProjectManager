...
open class CardMemberListItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val ivAddMember= holder.itemView.findViewById<CircleImageView>(R.id.iv_add_member)
        val ivSelectedMemberImage= holder.itemView.findViewById<CircleImageView>(R.id.iv_selected_member_image)
